...
public class ExpandableDescriptionAdapter extends BaseExpandableListAdapter{

    private Context context;
    private String[] groupHeaders;
    private String[][] childItems;

    public ExpandableDescriptionAdapter(Context context, String[] groupHeaders, String[][] childItems) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.description_option_causes, null);
        TextView childDescriptionTextView = view.findViewById(R.id.child_text);
        childDescriptionTextView.setText(childItems[groupPosition][childPosition]);
